...
import com.system.basketball_management_system.Pojo.UserPojo;
...
//    }
    ...
    public String getBasketballProfiile(@PathVariable("id") Integer id, Model model, Principal principal ){
        ...
        model.addAttribute("userdata",userService.findByEmail(principal.getName()));
        model.addAttribute("bookedbasketball", booking);
        return "editbooking";
    }
...
//        Booking booking =bookingService.fetchById(id);
//        model.addAttribute("bookedbasketball", new BookingPojo(booking));
//        return "redirect:/home/homepage";
//    }
