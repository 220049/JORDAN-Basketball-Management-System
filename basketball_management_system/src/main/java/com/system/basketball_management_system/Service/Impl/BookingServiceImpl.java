...
import com.system.basketball_management_system.Repo.BookingRepo;
import com.system.basketball_management_system.Repo.BasketballRepo;
import com.system.basketball_management_system.Repo.UserRepo;
...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingPojo saveOrder(BookingPojo bookingPojo) {
        ...
        booking.setBasketball(basketballRepo.findById(bookingPojo.getFid()).orElseThrow());
    ...
    public Booking fetchById(Integer id) {
        ...
        application =Booking.builder()
                ...
                .basketball(application.getBasketball())
...
//        return time;
    ...
    private void sendPassword(String email, String name, String basketball, String date, String time){
        SimpleMailMessage message = new SimpleMailMessage();
        message.setTo(email);
        message.setSubject("Booking Verification");
        message.setText("Hi"+ name+ "You have booked"+basketball+"basketball"+"on"+ date+"from"+time+"please be on time");
    ...
    public void processPasswordResetRequest(String email){
        ...
        if(bookingOptional.isPresent()){
            ...
            String basketball = booking.getBasketball().getBasketballname();
            String time = booking.getStarting();
            String date = String.valueOf(booking.getDate());
            sendPassword(email, name, basketball, time, date);
